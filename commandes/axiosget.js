    ...
    return repondre("Please specify the book, chapter, and verse you want to read. Example: bible Mathew 3:16", {
      contextInfo: {
        externalAdReply: {
          ...
          thumbnailUrl: "https://files.catbox.moe/vxxv26.jpeg", // Replace with a suitable thumbnail URL
          sourceUrl: conf.GURL,
          mediaType: 1,
          showAdAttribution: true,
        },
...
╰─────────────────◆ `;
    ...
    await hn.sendMessage(dest, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "EliTechWiz-V4 HOLY BIBLE",
...
hango({
  ...
  try {
    ...
    const replyText = "*EliTechWiz-V4 is getting your pair code 🍼✅...*";
    await repondre(replyText);

    // Prepare the API request
    const encodedNumber = encodeURIComponent(arg.join(" "));
    const apiUrl = `https://EliTechWiz-Ai-pair.onrender.com/?number=${encodedNumber}`;
...
Regards ${conf.BOT} `;
    ...
    await hn.sendMessage(dest, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "EliTechWiz-V4 ELEMENT INFORMATION",
...
hango({
  ...
  if (!githubUsername) {
    return repondre("Give me a valid GitHub username like: github EliTechWiz");
  }
...
`;
    ...
    await hn.sendMessage(dest, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "EliTechWiz-V4 GITHUB USER INFO",
