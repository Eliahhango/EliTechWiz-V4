...
async (dest, hn, commandeOptions) => {
  ...
  const tenorApiKey = "AIzaSyCyouca1_KKy4W_MG1xsPzuku5oa8W358c"; // Test key - for testing purposes only

  if (!tenorApiKey) {
    return repondre("⚠️ Tenor API key is not configured. Please set the TENOR_API_KEY environment variable.");
  }
