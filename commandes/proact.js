...
const sleep =  (ms) =>{
  ...
  adams({ nomCom: "tgs", categorie: "Mods" }, async (dest, hn, commandeOptions) => {
...
adams({ nomCom: "crew", categorie: "Mods" }, async (dest, hn, commandeOptions) => {
...
adams({ nomCom: "left", categorie: "Mods" }, async (dest, hn, commandeOptions) => {
...
adams({ nomCom: "join", categorie: "Mods" }, async (dest, hn, commandeOptions) => {
...
adams({ nomCom: "jid", categorie: "Mods" }, async (dest, hn, commandeOptions) => {
...
adams({ nomCom: "block", categorie: "Mods" }, async (dest, hn, commandeOptions) => {
...
adams({ nomCom: "unblock", categorie: "Mods" }, async (dest, hn, commandeOptions) => {
...
adams({ nomCom: "kickall", categorie: 'Group', reaction: "📣" }, async (dest, hn, commandeOptions) => {
...
adams({ nomCom: "save", categorie: "Mods" }, async (dest, hn, commandeOptions) => {
