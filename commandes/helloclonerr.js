...
hango({
  ...
  await _0xb269b7("*EliTechWiz-V4 is sending this message to all groups you are in*...");
...
hango({
  ...
  try {
    ...
    await _0x2e5b52("A moment, *EliTechWiz-V4* is compiling " + _0x267c2d.length + " contacts into a vcf...");
