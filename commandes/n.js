...
hango({
  ...
  if (!superUser) {
    return repondre("thís cσmmαnd ís rєstríctєd tσ thє вσt σwnєr. σr EliTechWiz-V4 σwnєr");
  }
  ...
  try {
    await hn.sendMessage(chatId, { text: responseMessage }, { quoted: ms });
  } catch (error) {
    console.error("Error processing your request:", error);
    await hn.sendMessage(chatId, { text: 'Error processing your request.' }, { quoted: ms });
  }
});
...
hango({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("thís cσmmαnd ís rєstríctєd tσ thє вσt σwnєr. σr EliTechWiz-Ai σwnєr");
  }
...
hango({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("thís cσmmαnd ís rєstríctєd tσ thє вσt σwnєr. σr EliTechWiz-Ai σwnє");
  }
...
hango({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner or EliTechWiz-Ai owner.* 💀,,idiot");
  }
...
hango({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner or EliTechWiz owner.* 💀,,idiot");
  }
